...
public interface FlightDao extends JpaRepository<Flight, Integer> {
    ...
    void updateFlight(Integer id, Integer routeId, Integer airplaneId, LocalDateTime departureTime, LocalDateTime arrivalTime, Integer firstReserved, Float firstPrice, Integer businessReserved, Float businessPrice, Integer economyReserved, Float economyPrice, Integer isActive);
